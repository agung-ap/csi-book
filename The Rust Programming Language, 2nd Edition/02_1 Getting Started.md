...
If you prefer not to use `rustup` for some reason, please see the Other Rust Installation Methods page at [https://forge.rust-lang.org/infra/other-installation-methods.html](https://forge.rust-lang.org/infra/other-installation-methods.html) for more options.
...
To acquire the build tools, you’ll need to install Visual Studio 2022 from [https://visualstudio.microsoft.com/downloads](https://visualstudio.microsoft.com/downloads). When asked which workloads to install, include:
...
If that’s all correct and Rust still isn’t working, there are a number of places you can get help. Find out how to get in touch with other Rustaceans (a silly nickname we call ourselves) on the community page at [https://www.rust-lang.org/community](https://www.rust-lang.org/community).
...
Now open the *main.rs* file you just created and enter the code in [Listing 1-1](https://learning.oreilly.com/library/view/the-rust-programming/9781098156817/c01.xhtml#listing1-1).
...
Regardless of your operating system, the string `Hello, world!` should print to the terminal. If you don’t see this output, refer back to “Troubleshooting” on page 3 for ways to get help.
...
Open *Cargo.toml* in your text editor of choice. It should look similar to the code in [Listing 1-2](https://learning.oreilly.com/library/view/the-rust-programming/9781098156817/c01.xhtml#listing1-2).
...
Cargo has generated a “Hello, world!” program for you, just like the one we wrote in [Listing 1-1](https://learning.oreilly.com/library/view/the-rust-programming/9781098156817/c01.xhtml#listing1-1)! So far, the differences between our project and the project Cargo generated are that Cargo placed the code in the *src* directory and we have a *Cargo.toml* configuration file in the top directory.
...
For more information about Cargo, check out its documentation at [https://doc.rust-lang.org/cargo](https://doc.rust-lang.org/cargo).
