...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/05fig01.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/05fig02.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/05fig03.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/t0086_01.jpg)

Table: CUSTOMER

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/t0086_02.jpg)

Table: INVESTMENT

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/t0086_03.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/05fig04.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/05inf01.jpg)
...
An object defined primarily by its identity is called an ENTITY.[1](https://learning.oreilly.com/library/view/domain-driven-design-tackling/0321125215/footnotes.html#ch05fn01a) ENTITIES have special modeling and design considerations. They have life cycles that can radically change their form and content, but a thread of continuity must be maintained. Their identities must be defined so that they can be effectively tracked. Their class definitions, responsibilities, attributes, and associations should revolve around who they are, rather than the particular attributes they carry. Even for ENTITIES that don’t transform so radically or have such complicated life cycles, placing them in the semantic category leads to more lucid models and more robust implementations.
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/05inf02.jpg)
...
The attributes that make up a VALUE OBJECT should form a conceptual whole.[2](https://learning.oreilly.com/library/view/domain-driven-design-tackling/0321125215/footnotes.html#ch05fn02a) For example, street, city, and postal code shouldn’t be separate attributes of a Person object. They are part of a single, whole address, which makes a simpler Person, and a more coherent VALUE OBJECT.

![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/05fig06.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/05inf03.jpg)
...
![Image](https://learning.oreilly.com/api/v2/epubs/urn:orm:book:0321125215/files/graphics/t0107_01.jpg)
...
Low coupling and high cohesion are general design principles that apply as much to individual objects as to MODULES, but they are particularly important at this larger grain of modeling and design. These terms have been around for a long time; one patterns-style explanation can be found in [Larman 1998](https://learning.oreilly.com/library/view/domain-driven-design-tackling/0321125215/bib01.html#biblio01entry17).
...
One exception arises when code is generated based on a declarative design (discussed in [Chapter 10](https://learning.oreilly.com/library/view/domain-driven-design-tackling/0321125215/ch10.html#ch10)). In that case, the developers do not need to read the code, and it is better to put it into a separate package so that it is out of the way, not cluttering up the design elements developers actually have to work with.

Modularity becomes more critical as the design gets bigger and more complex. This section presents the basic considerations. Much of [Part IV](https://learning.oreilly.com/library/view/domain-driven-design-tackling/0321125215/part04.html#part04), “[Strategic Design](https://learning.oreilly.com/library/view/domain-driven-design-tackling/0321125215/part04.html#part04),” provides approaches to packaging and breaking down big models and designs, and ways to give people focal points to guide understanding.
